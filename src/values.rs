...
pub(crate) fn vec4_from(var: Vec4) -> vec4{
	vec4{x: var.x, y: var.y, z: var.z, w: var.w}
}
...
pub(crate) fn color32_from(var: Color32) -> color32 {
	color32{r: var.red(), g: var.green(), b: var.blue(), a: var.alpha()}
}
...
pub(crate) fn color128_from(var: Color128) -> color128 {
	color128{r: var.red(), g: var.green(), b: var.blue(), a: var.alpha()}
}
